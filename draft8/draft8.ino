...
int pumpTime, XUnit= (1000/3), YUnit = (7000/2), ZUnit = 1000, Xcalib = 0; //Xcalib is the (time taken*10) for 6 plants along X axis, adjust and calibrate for perfect XC val
...
void xaxis(int XT, int XC)
{
  ...
  Serial.println(abs(XT)*XC*XUnit/1000);
  lcd.setCursor(-4,2);    
